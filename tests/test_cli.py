...
from clonebox.detector import SystemDetector, SystemSnapshot, DetectedService, DetectedApplication, DetectedPath
...
class TestGenerateCloneboxYaml:
    ...
    def create_mock_snapshot(self):
        ...
        apps = [
            DetectedApplication("python3", 1234, "python3 app.py", "/usr/bin/python3", 
                              "/home/user/project", 100.0),
            DetectedApplication("node", 5678, "node server.js", "/usr/bin/node",
                              "/home/user/webapp", 200.0),
        ]
        paths = [
